...
namespace ChatAnalyzer.Analyze
{
    public partial class AnalyzeNextWordsDialog : Form
    {
        ...
        {
                AnalyzeNextWords.Analyze(textBoxWord.Text.ToLower(), radioButtonKindPersonal.Checked, Int32.Parse(textBoxAmountWords.Text), Int32.Parse(textBoxMinRepeat.Text));
